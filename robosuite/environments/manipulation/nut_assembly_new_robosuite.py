...
class NutAssembly(ManipulationEnv):
    ...
    def _setup_observables(self):
        ...
        print("nut assembly: setting up object observables")
    ...
    def _reset_internal(self):
        ...
        """
        print("super resetting internal")
        super()._reset_internal()
        print("done super resetting internal")

        # Reset all object positions using initializer sampler if we're not directly loading from an xml
        print("resetting object positions")
        ...
        print("done resetting object positions")
        # Move objects out of the scene depending on the mode
        print("moving objects out of the scene")
        ...
        print("done moving objects out of the scene")
        print("making nut {} active".format(self.obj_to_use))
        ...
        print("done with nut assembly reset")
